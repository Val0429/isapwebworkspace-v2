<template>
    ...
    <div
        ref="cameraDetail"
        class='tag-label-device-fisheye-camera-icon'
...
export class TagLabelDeviceFisheyeCamera extends Vue {
    eDragType = EDragType;
...
export default TagLabelDeviceFisheyeCamera;
Vue.component("tag-label-device-fisheye-camera", TagLabelDeviceFisheyeCamera);
</script>

<style lang="scss" scoped>
.tag-label-device-fisheye-camera-icon {
    margin: 10px 0;
    padding: 10px;
    color: #fff;
