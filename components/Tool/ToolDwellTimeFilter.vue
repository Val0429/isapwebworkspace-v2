...
import { IRepeatVisitorFilter, ITrafficFilter, IFilter } from "./ITool";
import { EDeviceMode } from "@/components/Reports";
@Component({
    components: {}
})
export class ToolDwellTimeFilter extends Vue {
    siteSelectItem: any = {};
    areaSelectItem: any = {};
...
export default ToolDwellTimeFilter;
Vue.component("tool-dwell-time-filter", ToolDwellTimeFilter);
</script>
