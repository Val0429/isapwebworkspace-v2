...
<script lang="ts">
    ...
    import { IFilter } from './ITool';
    @Component({
        components: {}
    })
    export class ToolDemographicFilter extends Vue {
        ...
        async doSubmit(data) {
            ...
            const submitParam: IFilter = {
                ...
                startDate: new Date(data.date.getFullYear(), data.date.getMonth(), data.date.getDate(), Number(data.hour)).toISOString(),
                endDate: new Date(data.date.getFullYear(), data.date.getMonth(), data.date.getDate(), Number(data.hour) + 1).toISOString(),
            };
        ...
        IFilterConditionForm() {
            ...
            interface {
                ...
                * @uiColumnGroup - row1
                 ...
                 * @uiColumnGroup - row2
                 */
                isEmployee: ${toEnumInterface(this.isIncludedEmployeeSelectItem as any, false)};
    ...
    export default ToolDemographicFilter;
    Vue.component("tool-demographic-filter", ToolDemographicFilter);
</script>
