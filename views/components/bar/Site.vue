...
export default class Site extends Vue {
    ...
    async getDeviceGroupData() {
        ...
        await this.$server
            .R("/device/group/all" as any, body)
            .then((response: any) => {
    ...
    async saveDeviceGroup(data) {
        ...
        if (this.pageStep == EPageStep.deviceGroupAdd) {
            ...
            await this.$server
                .C("/device/group" as any, addDeviceGroupParam)
                .then((response: any) => {
                    if (response != undefined) {
            ...
            await this.$server
                .U("/device/group" as any, editDeviceGroupParam)
                .then((response: any) => {
                    if (response != undefined) {
