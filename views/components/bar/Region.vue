...
export default class Region extends Vue {
    ...
    async pageToBindingSite() {
        ...
        await this.$server
            .R("/location/site/all" as any, param)
            .then((response: any) => {
    ...
    async clickSaveModifyRegion(data: any) {
        ...
        if (
            ...
            await this.$server
                .C("/location/region" as any, param)
                .then((response: any) => {
                    if (response != undefined) {
                        this.pageToTree();
                    }
            ...
            await this.$server
                .U("/location/region" as any, param)
                .then((response: any) => {
                    if (response != undefined) {
                        this.pageToTree();
                    }
    ...
    async clickSaveBindingSite(data: any) {
        ...
        await this.$server
            .U("/location/site/binding-region" as any, param)
            .then((response: any) => {
                if (response != undefined) {
                    this.pageToTree();
                }
    ...
    async deleteRegionConfirm() {
        ...
        await this.$server
            .D("/location/region" as any, param)
            .then((response: any) => {
                if (response != undefined) {
                    this.pageToTree();
                }
