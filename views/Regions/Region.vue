...
// import { toEnumInterface, Dialog } from "@/../helpers";
...
// import { ERegionType } from "@/models/trees";
// import { IRegionItem } from "@/models/trees";
// import { RegionTreeItem } from "../../models/trees/RegionTreeItem";
...
//             }
//         }
//         await Server.R("/location/site/all", param)
//             .then((response: any) => {
...
//         await Server.R("/location/tree", param)
//             .then((response: any) => {
//                 if (response != undefined) {
...
//         ) {
//             await Server.C("/location/region", param)
//                 .then((response: any) => {
//                     if (response != undefined) {
//                         this.pageToTree();
//                     }
...
//                 });
//         } else {
//             await Server.U("/location/region", param)
//                 .then((response: any) => {
//                     if (response != undefined) {
//                         this.pageToTree();
//                     }
...
//         }
//         await Server.U("/location/site/binding-region", param)
//             .then((response: any) => {
//                 if (response != undefined) {
//                     this.pageToTree();
//                 }
...
//         await Server.D("/location/region", param)
//             .then((response: any) => {
//                 if (response != undefined) {
//                     this.pageToTree();
//                 }
