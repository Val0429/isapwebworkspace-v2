    ...
    <div class="animated fadeIn">
        ...
        >
            ...
            <iv-card
                ...
                :label="_('w_VSHumanDetection_List')"
            >
            ...
            <iv-card
                ...
                :label="_('w_VSHumanDetection_View')"
            >
            ...
            <iv-auto-card
                ...
                :label="inputFormData.objectId == '' ? _('w_VSHumanDetection_Add') :  _('w_VSHumanDetection_Edit')"
            >
                ...
                >
                    ...
                    <template #1-title>{{_('w_VSHumanDetection_SelectBrand')}}</template>
                    ...
                    <template #2-title>{{_('w_VSHumanDetection_SelectRegion')}}</template>
                    ...
                    <template #3-title>{{_('w_VSHumanDetection_DrawROI')}}</template>

                    <!-- <template #4>
                        <iv-form :interface="inf4()" />
                    </template>
                    <template #4-title>{{_('w_VSHumanDetection_CheckAndOverlook')}}</template> -->
...
export default class HumanDetection extends Vue {
    ...
    goToSetCMS() {
        Dialog.confirm(
            this._("w_VSHumanDetection_PageToCMSAlter"),
            this._("w_DeleteConfirm"),
            () => {
        ...
        return `
            interface {
                ...
                */
                ...
                /**
                * @uiLabel - ${this._("w_VSHumanDetection_Name")}
                * @uiPlaceHolder - ${this._("w_VSHumanDetection_Name")}
                * @uiType - iv-form-string
                */
                name: string;

                /*
                * @uiLabel - ${this._("w_VSHumanDetection_Brand")}
                ...
                */
                 serverId?: any;
                  ...
                  /*
                * @uiLabel - ${this._("w_VSHumanDetection_NVR")}
                * @uiType - iv-form-selection
                * @uiAttrs - { multiple: false }
                */
                nvrId?: any;
                    ...
                    /*
                * @uiLabel - ${this._("w_VSHumanDetection_ChannelInNVR")}
                * @uiType - iv-form-selection
                * @uiAttrs - { multiple: false }
                */
                channelId?: any;
        ...
        interface {
           /**
                ...
                */
                ...
                /*
                * @uiLabel - ${this._("w_VSHumanDetection_Site")}
                * @uiType - iv-form-label
                */
                siteId?: ${toEnumInterface(this.sitesSelectItem as any, false)};
                ...
                /*
                * @uiLabel - ${this._("w_VSHumanDetection_Area")}
                * @uiType - iv-form-label
                */
                 areaId?: ${toEnumInterface(this.areaSelectItem as any, false)};
                 ...
                 /*
                * @uiLabel - ${this._("w_VSHumanDetection_DeviceGroup")}
                * @uiType - iv-form-label
