...
$({ path: '/reports', name: "_('w_Navigation_Reports')", icon: 'fa-check', redirect: '/reports/dashboard' })();
$({ path: '/reports/dashboard', name: "_('w_Navigation_Reports_Dashboard')", icon: 'fa-check' })(ReportsDashboard);
$({ path: '/reports/investigation', name: "_('w_Navigation_Reports_Investigation')", icon: 'fa-check' })(ReportsInversigation);
...
$({ path: '/setups', name: "_('w_Navigation_Setups')", icon: 'fa-check', redirect: '/setups/account' })();
$({ path: '/setups/floor', name: "_('w_Navigation_Setups_Floor')", icon: 'fa-check' })(SetupsFloor);
$({ path: '/setups/company', name: "_('w_Navigation_Setups_Company')", icon: 'fa-check' })(SetupsCompany);
$({ path: '/setups/account', name: "_('w_Navigation_Setups_Account')", icon: 'fa-check' })(SetupsAccount);
$({ path: '/setups/kiosk', name: "_('w_Navigation_Setups_Kiosk')", icon: 'fa-check' })(SetupsKiosk);
$({ path: '/setups/license', name: "_('w_Navigation_Setups_License')", icon: 'fa-check' })(SetupsLicense);
