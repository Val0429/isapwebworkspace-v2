...
import DemoAnalysisFilterComponent from './Demos/DemoAnalysisFilterComponent.vue';
...
$({ path: '/demos/report_filter_analysis_component', name: 'Analysis Filter Component', icon: 'fa-check' })(DemoAnalysisFilterComponent);
